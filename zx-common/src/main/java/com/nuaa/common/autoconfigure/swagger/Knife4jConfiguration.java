package com.nuaa.common.autoconfigure.swagger;
...
@Configuration
@ConditionalOnProperty(prefix = "nhzx.swagger", name = "enable", havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "nhzx.swagger.enable", havingValue = "true")
    ...
    // @Bean
    // @Primary
    // @ConditionalOnProperty(prefix = "nhzx.swagger", name = "enableResponseWrap",havingValue = "true")
