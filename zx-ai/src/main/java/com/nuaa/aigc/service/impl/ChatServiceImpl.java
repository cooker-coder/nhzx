...
import com.nuaa.aigc.config.ToolResultHolder;
import com.nuaa.aigc.constants.Constant;
import com.nuaa.aigc.enums.ChatEventTypeEnum;
...
@ConditionalOnProperty(prefix = "nhzx.ai", name = "chat-type", havingValue = "ENHANCE")
