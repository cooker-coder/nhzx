...
import com.nuaa.aigc.advisor.RecordOptimizationAdvisor;
import com.nuaa.aigc.memory.MyChatMemoryRepository;
import com.nuaa.aigc.memory.RedisChatMemoryRepository;
import com.nuaa.aigc.memory.jdbc.JdbcChatMemoryRepository;
import com.nuaa.aigc.memory.mongodb.MongoDBChatMemoryRepository;
import com.nuaa.aigc.tools.CourseTools;
import com.nuaa.aigc.tools.OrderTools;
import com.nuaa.common.constants.Constant;
import com.nuaa.common.utils.WebUtils;
...
public class SpringAIConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "nhzx.ai.memory", value = "type", havingValue = "Redis")
    public ChatMemoryRepository redisChatMemoryRepository() {
        return new RedisChatMemoryRepository();
    }

    @Bean
    @ConditionalOnProperty(prefix = "nhzx.ai.memory", value = "type", havingValue = "MYSQL")
    public ChatMemoryRepository jdbcChatMemoryRepository() {
        return new JdbcChatMemoryRepository();
    }

    @Bean
    @ConditionalOnProperty(prefix = "nhzx.ai.memory", value = "type", havingValue = "MongoDB")
