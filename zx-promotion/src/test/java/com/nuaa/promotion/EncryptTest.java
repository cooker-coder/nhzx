package com.nuaa.promotion;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.crypto.SecureUtil;
import cn.hutool.crypto.digest.HMac;
import com.nuaa.common.exceptions.BadRequestException;
import com.nuaa.promotion.utils.AESUtil;
import com.nuaa.promotion.utils.Base32;
import com.nuaa.promotion.utils.BitConverter;
...
public class EncryptTest {
    ...
    private AESUtil aesUtil = new AESUtil("nhzx-test-key-in", "nhzx-test-ivinit");
    @Test
    ...
    // @Test
    // void testCodeUtil() {
    //     CodeUtil codeUtil = new CodeUtil(new AESUtil("nhzx-test-key-in", "nhzx-test-ivinit"));
    //
