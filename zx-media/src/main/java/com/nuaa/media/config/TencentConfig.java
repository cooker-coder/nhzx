...
import com.nuaa.media.storage.tencent.TencentFileStorage;
import com.nuaa.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "nhzx.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "nhzx.platform", name = "file", havingValue = "TENCENT")
