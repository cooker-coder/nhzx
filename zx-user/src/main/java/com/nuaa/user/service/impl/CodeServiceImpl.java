...
import com.nuaa.message.domain.enums.SmsTemplate;
import com.nuaa.common.exceptions.BadRequestException;
import com.nuaa.common.utils.CollUtils;
import com.nuaa.common.utils.RandomUtils;
import com.nuaa.common.utils.StringUtils;
import com.nuaa.message.api.client.AsyncSmsClient;
import com.nuaa.message.domain.dto.SmsInfoDTO;
import com.nuaa.user.service.ICodeService;
...
import static com.nuaa.api.constants.SmsConstants.VERIFY_CODE_PARAM_NAME;
import static com.nuaa.common.constants.ErrorInfo.Msg.INVALID_VERIFY_CODE;
import static com.nuaa.user.constants.UserConstants.USER_VERIFY_CODE_KEY;
import static com.nuaa.user.constants.UserConstants.USER_VERIFY_CODE_TTL;
